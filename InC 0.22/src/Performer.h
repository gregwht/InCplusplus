...
public:
    ...
    void setup(int _channel, float _tempo, float _factor); // Setup function, passing through desired MIDI channel, tempo. and factor
    ...
    float initThreshold;                    // What we initialise the threshold to be
