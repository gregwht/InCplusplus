...
void ofApp::draw() {
	...
	text << "connected to port " << midiOut.getPort() 
         ...
         << "progress: " << progress << endl << endl << endl << endl << endl << endl << endl << endl << endl
...
void ofApp::audioRequested 	(float * output, int bufferSize, int nChannels){
    ...
    // When translating to classes,
    // put this loop in it's own method
    // called myAudio().
    // Then, in ofApp.cpp, call:
    // performer[i].myAudio()
...
//-------------------------------------------------------------------------------------
        ...
        if (beatCheck == true){
            ...
            // Check to see if we have progressed to new bar
