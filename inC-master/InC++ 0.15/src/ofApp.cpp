...
void ofApp::setup() {
    ...
    c.setup(1, tempo);    // Send to MIDI channel 1, set tempo to 120 bpm
    ...
    for (int i = 1; i < PERFORMER_NUM+1; i++){
        ...
        performer[i].setup(i, tempo);     // Send to MIDI channel i, set tempo to 120 bpm
    ...
    for (int i = 0; i < bufferSize; i++){
        ...
        for (int i = 1; i < PERFORMER_NUM+1; i++){
            ...
            for (int j = 1; j < PERFORMER_NUM+1; j++){
                ...
                // If the distance between performers is 3 bars or greater...
                if (performer[i].currentBar - performer[j].currentBar >= 3){
